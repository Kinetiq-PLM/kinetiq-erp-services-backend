...
class ServiceBilling(models.Model):
    ...
    renewal = models.ForeignKey(WarrantyRenewal, on_delete=models.CASCADE, blank=True, null=True)
    analysis = models.ForeignKey(ServiceAnalysis, on_delete=models.CASCADE, blank=True, null=True)
    ...
    operational_cost = models.ForeignKey('connection.OpCost', on_delete=models.CASCADE, blank=True, null=True)
