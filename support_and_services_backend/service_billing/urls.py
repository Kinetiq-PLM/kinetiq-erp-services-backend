...
urlpatterns = billing_router.urls + [
    ...
    path('renewals-billings/<str:renewal_id>/', get_filtered_bill_renewal, name='filtered-bill-renewal'),
    path('requests-billings/<str:service_request_id>/', get_filtered_bill_renewal, name='filtered-bill-request'),
]