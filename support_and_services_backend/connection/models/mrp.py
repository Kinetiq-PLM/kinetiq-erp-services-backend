...
class Pricing(models.Model):
    ...
    price_id = models.CharField(primary_key=True, max_length=255, editable=False) 
    item = models.ForeignKey("connection.ItemMasterData", on_delete=models.CASCADE, null=False, blank=True) 
